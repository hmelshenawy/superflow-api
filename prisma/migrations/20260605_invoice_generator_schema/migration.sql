...
CREATE TABLE `workshop_invoices` (
    ...
    `snapshot_vehicle_make` VARCHAR(80) NULL,
    `snapshot_vehicle_color` VARCHAR(40) NULL,
    `snapshot_advisor_name` VARCHAR(120) NULL,
