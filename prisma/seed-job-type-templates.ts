...
const templates = [
  ...
  ['AC & Cooling', 'AC compressor replacement', 180, '#3DA88A'],
  ['AC & Cooling', 'AC condenser replacement', 120, '#2BB894'],
  ['AC & Cooling', 'Cabin air filter replacement', 30, '#8FD9C5'],
  ['AC & Cooling', 'AC leak detection & repair', 90, '#45B896'],
  ['AC & Cooling', 'Cooling system flush', 60, '#6CCFB0'],
