...
import { UsersModule } from '@modules/admin/usage/users/users.module';
...
import { AuditModule } from '@modules/admin/audit-log/audit.module';
import { AdminModule } from '@modules/admin/settings/admin.module';
import { ScheduleModule } from '@nestjs/schedule';
import { SchedulerModule } from './scheduler/scheduler.module';
import { InsightsModule } from '@modules/insights/insights.module';
import { BookingImportModule } from '@modules/admin/dms-imports/booking-import/booking-import.module';
import { PriorityModule } from '@modules/jobs/priority/priority.module';
import { WorkshopsModule } from '@modules/admin/locations/workshops.module';
import { BillingModule } from '@modules/admin/usage/billing.module';
import { BlockersModule } from '@modules/jobs/blockers/blockers.module';
...
import { JobPartsModule } from '@modules/parts/job-parts/job-parts.module';
import { PurchaseOrdersModule } from '@modules/parts/purchase-orders/purchase-orders.module';
import { QcChecklistsModule } from '@modules/inspections/qc-checklists/qc-checklists.module';
import { DmsModule } from '@modules/admin/dms-imports/dms/dms.module';
import { CrmModule } from '@modules/customers/crm/crm.module';
import { JobTypesModule } from '@modules/jobs/job-types/job-types.module';
