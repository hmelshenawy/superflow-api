...
export class InvoicePdfService {
  ...
  async generateInvoicePdf(invoiceId: string): Promise<Buffer> {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (invoice.notes) this.renderNotes(doc, invoice.notes, y);
  ...
  private renderFooter(doc: PDFDoc): void {
    ...
    doc.text('Generated by PrioraFlow', 50, y + 8, { width: 400, align: 'left' });
    doc.text('Page 1 of 1', 450, y + 8, { width: 95, align: 'right' });
  }
}