...
export class AuthorisationQueryService {
  ...
  //
  // Kept accessible (not private) so that AuthorisationService and
  // AuthorisationDecisionService can reuse the token lookup + validation.
  async getValidTokenByRaw(rawToken: string) {
