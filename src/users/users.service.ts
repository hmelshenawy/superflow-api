...
export class UsersService {
  ...
  async findOne(id: string) {
    const user = await this.prisma.raw.users.findUnique({ where: { id }, select: { id: true, name: true, email: true, role_id: true, employee_code: true, is_active: true, avatar_url: true, last_login_at: true, created_at: true, updated_at: true, roles: { select: { id: true, name: true, permissions: true, description: true } } } });
